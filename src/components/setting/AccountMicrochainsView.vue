<template>
  <div>
    ...
    <div class='vertical-menus-margin text-grey-8 text-bold decorate-underline'>
      Microchains
    </div>
    <div class='vertical-items-margin'>
      <MicrochainsInnerView :searchable='false' :show-indicator='false' @selected='onMicrochainSelected' />
      <div class='row vertical-sections-margin selector-margin-left cursor-pointer' @click='onAddMicrochainClick'>
