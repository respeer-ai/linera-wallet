  ...
  <q-item class='row full-width tab-panel-item' clickable>
    ...
    <div>
      <div class='text-bold text-grey-9 text-right'>
        {{ microchain.balance }} <span class='selector-item-currency-sub'>TLINERA</span>
      </div>
...
const chainOwnerBalance = computed(() => microchainOwners.value.reduce((sum, a) => sum + a.balance, 0))
