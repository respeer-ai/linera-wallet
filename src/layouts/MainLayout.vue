  ...
  <q-layout view='hHh Lpr hff'>
    ...
    <q-page-container>
      <div :style='{padding: "24px", margin: "16px", borderRadius: "16px"}' class='bg-grey-4 text-brown-10'>
        ...
        CheCko won't DM anyone to get money for any reason, and won't provide any type activities about Linera mainnet token. And, CheCko is only a third-party open source wallet solution for Linera
