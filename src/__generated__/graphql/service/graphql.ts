...
export type TransferWithoutBlockProposalMutationVariables = Exact<{
  fromPublicKey?: InputMaybe<Scalars['PublicKey']['input']>;
  fromChainId: Scalars['ChainId']['input'];
  toPublicKey?: InputMaybe<Scalars['PublicKey']['input']>;
  toChainId: Scalars['ChainId']['input'];
...
export type TransferWithoutBlockProposalMutation = { __typename?: 'MutationRoot', transferWithoutBlockProposal: any };
