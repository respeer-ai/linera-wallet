...
export type GetChainAccountBalancesQueryVariables = Exact<{
  ...
  publicKeys:
    | Array<Scalars['PublicKey']['input']>
    | Scalars['PublicKey']['input']
}>

export type GetChainAccountBalancesQuery = {
  __typename?: 'QueryRoot'
  balances: any
}
...
export type ChainsWithPublicKeyQuery = {
  __typename?: 'QueryRoot'
  chainsWithPublicKey: {
    __typename?: 'Chains'
    list: Array<any>
...
export type WalletInitWithoutKeypairMutation = {
  __typename?: 'MutationRoot'
  walletInitWithoutKeypair: any
}
...
export type GetPendingRawBlockQuery = {
  __typename?: 'QueryRoot'
  peekCandidateRawBlockPayload?: {
    __typename?: 'RawBlockProposalPayload'
    height: any
...
export type SubmitBlockSignatureMutation = {
  __typename?: 'MutationRoot'
  submitBlockSignature: any
}
...
export type SubmitBlockAndSignatureMutation = {
  __typename?: 'MutationRoot'
  submitBlockAndSignature: any
}
    ...
    value: {
      ...
      executedBlock?: {
        ...
        block: {
          ...
          height: any
          timestamp: any
          authenticatedSigner?: any | null
          previousBlockHash?: any | null
        ...
        outcome: {
          __typename?: 'BlockExecutionOutcome'
          stateHash: any
          oracleResponses: Array<Array<any>>
          messages: Array<
            Array<{
              __typename?: 'OutgoingMessage'
              destination: any
...
export type BlockMaterialQuery = {
  __typename?: 'QueryRoot'
  blockMaterial: {
    __typename?: 'CandidateBlockMaterial'
    localTime: any
...
export type ExecuteBlockWithFullMaterialsMutationVariables = Exact<{
  chainId: Scalars['ChainId']['input']
  operations:
    | Array<Scalars['Operation']['input']>
    | Scalars['Operation']['input']
  incomingBundles:
    | Array<Scalars['UserIncomingBundle']['input']>
    | Scalars['UserIncomingBundle']['input']
  localTime: Scalars['Timestamp']['input']
}>
...
export type PendingMessagesQuery = {
  __typename?: 'QueryRoot'
...
export type TransferMutation = {
  __typename?: 'MutationRoot'
  transferWithoutBlockProposal: any
}
...
>
export const GetChainAccountBalancesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getChainAccountBalances' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'chainIds' }
          },
          type: {
            kind: 'NonNullType',
            type: {
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'publicKeys' }
          },
          type: {
            kind: 'NonNullType',
            type: {
  ...
  GetChainAccountBalancesQuery,
  GetChainAccountBalancesQueryVariables
>
...
export const ChainsWithPublicKeyDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'chainsWithPublicKey' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  ChainsWithPublicKeyQuery,
  ChainsWithPublicKeyQueryVariables
>
export const WalletInitWithoutKeypairDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'walletInitWithoutKeypair' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'faucetUrl' }
          },
          type: {
            kind: 'NonNullType',
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'CryptoHash' }
            }
          }
        }
      ],
  ...
  WalletInitWithoutKeypairMutation,
  WalletInitWithoutKeypairMutationVariables
>
export const GetPendingRawBlockDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getPendingRawBlock' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'peekCandidateRawBlockPayload' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'chainId' },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'payloadBytes' } }
              ]
            }
          }
        ]
  ...
  GetPendingRawBlockQuery,
  GetPendingRawBlockQueryVariables
>
export const SubmitBlockSignatureDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'submitBlockSignature' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  SubmitBlockSignatureMutation,
  SubmitBlockSignatureMutationVariables
>
export const SubmitBlockAndSignatureDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'submitBlockAndSignature' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'executedBlock' }
          },
          type: {
            kind: 'NonNullType',
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'UserExecutedBlock' }
            }
          }
        },
        {
  ...
  SubmitBlockAndSignatureMutation,
  SubmitBlockAndSignatureMutationVariables
>
                            ...
                            },
                            {
                              ...
                              selectionSet: {
                                ...
                                selections: [
                                  ...
                                  {
                                    kind: 'Field',
                                    name: { kind: 'Name', value: 'stateHash' }
                                  },
                                  {
                                    kind: 'Field',
                                    name: {
                                      kind: 'Name',
                                      value: 'oracleResponses'
                                    }
                                  },
                                  {
                                    kind: 'Field',
...
export const BlockMaterialDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'blockMaterial' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'incomingBundles' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'transactionIndex' }
                            },
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'messages' },
...
} as unknown as DocumentNode<BlockMaterialQuery, BlockMaterialQueryVariables>
export const ExecuteBlockWithFullMaterialsDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'executeBlockWithFullMaterials' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                ...
                type: {
                  kind: 'NamedType',
                  name: { kind: 'Name', value: 'UserIncomingBundle' }
                }
              }
            }
          }
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'authenticatedSigner' }
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'previousBlockHash' }
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'incomingBundles' },
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'refundGrantTo' }
                            },
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'kind' }
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'oracleResponses' }
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'events' },
  ...
  ExecuteBlockWithFullMaterialsMutation,
  ExecuteBlockWithFullMaterialsMutationVariables
>
export const PendingMessagesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'fromPublicKey' }
          },
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'PublicKey' }
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'toPublicKey' }
          },
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'PublicKey' }
        ...
        },
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'Amount' } }
          }
        }
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'transferWithoutBlockProposal' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'fromPublicKey' },
...
} as unknown as DocumentNode<TransferMutation, TransferMutationVariables>
