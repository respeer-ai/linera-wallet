...
export class MicrochainOwnerFungibleTokenBalance {
  static balance = async (microchain: string, owner: string, token: number): Promise<db.MicrochainOwnerFungibleTokenBalance | undefined> => {
  ...
  static create = async (microchain: string, owner: string, token: number, balance: number) => {
