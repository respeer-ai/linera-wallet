...
const onSaveClick = () => {
  _setting.setFaucet(faucetSchema.value, faucetWSSchema.value, faucetHost.value, faucetPort.value)
  _setting.setRPC(rpcSchema.value, rpcWSSchema.value, rpcHost.value, rpcPort.value)
