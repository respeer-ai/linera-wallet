...
export default {
  ...
  MSG_FAILED_SYNCHRONIZE_APPLICATIONS: 'Failed synchronize applications: { ERROR }',
  ...
  MSG_SUCCESS_COPY_MICROCHAIN_CREATION_INFORMATION: 'Success copy microchain creation information to clipboard.',
  MSG_SUCCESS_SYNCHRONIZE_MICROCHAINS: 'Success synchronize microchains.',
  MSG_FAILED_SYNCHRONIZE_MICROCHAINS: 'Failed synchronize microchains: { ERROR }',
  MSG_RESTORE_WALLET: 'Restore wallet',
  MSG_FAILED_RESTORE_WALLET: 'Failed restore wallet. Please confirm you input correct password.',
