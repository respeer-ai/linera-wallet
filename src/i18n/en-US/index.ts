...
export default {
  ...
  MSG_NEVER_SHARE_PRIVATE_KEY_TO_ANYONE_ELSE:
    '<strong>Please never share private key to anyone else.</strong> ' +
  ...
  MSG_DONT_SAVE_MNEMONIC_PROPERLY_SAFE_TO_CREATE_NEW:
    "If you don't save mnemonic properly, it's safe to create a new one and discard the this one at this step.",
